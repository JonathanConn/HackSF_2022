...
export declare type AnyVariables = {
    [prop: string]: any;
} | void | undefined;
/** A Graphql query, mutation, or subscription. */
export interface GraphQLRequest<Data = any, Variables extends AnyVariables = AnyVariables> {
...
export declare type OperationInstance = number & {
...
export interface Operation<Data = any, Variables extends AnyVariables = AnyVariables> extends GraphQLRequest<Data, Variables> {
